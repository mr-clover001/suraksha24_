...
// channel, so its detail page gets bespoke treatment (photo, icon grid) via
// InternationalPatientsContent — every other service keeps the plain generic
// layout below. It also has its own top-level route at
// /international-patients-services (see app/international-patients-services).
