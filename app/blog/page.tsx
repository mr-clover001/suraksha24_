    ...
    <>
      <section className="relative isolate overflow-hidden">
        <MobileHero
          ...
          description="Practical, calm reading on caring for elderly parents in India — written for every family juggling care alongside everything else."
          image={{
